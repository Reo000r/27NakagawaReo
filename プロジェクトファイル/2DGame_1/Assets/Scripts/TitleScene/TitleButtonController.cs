...
public class TitleButtonController : MonoBehaviour
{
    ...
    private const float kScaleX = 1.5f;
    private const float kScaleY = 1.0f;
    private const float kMaxScaleX = 1.65f;
    ...
    void Update()
    {
        ...
        else if (!canClick && isClick && !isClickAnimEnd)
        {
            ...
            {
                isSceneChange = true;
                _titleSoundManager.PlaySceneChangeSE();
                _titleSoundManager.IsTitleBGMFadeOut = true;
                _titlePerformanceManager.SceneChangeAnim(_sceneName);
            }
